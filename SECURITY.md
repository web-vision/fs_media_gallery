...
This product ("web-vision/fs-media-gallery") is developed and maintained by web-vision GmbH.
...
Planned end of support for this product: **30 April 2023 (end of regular TYPO3 10 LTS support)**.
...
channels of "web-vision/fs-media-gallery" (e.g. TER / Packagist).
